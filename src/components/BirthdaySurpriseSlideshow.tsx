...
const DEFAULT_SLIDES: SlideItem[] = [
  {
    ...
    type: 'image',
    url: '/IMG_6700.PNG',
    caption: 'Laughter like Sunshine',
    subtitle: 'A radiant smile that lights up every room with pure warmth ☀️',
  },
  {
    id: 'slide-2',
    type: 'image',
    url: '/IMG_6701.PNG',
    caption: 'Bright Smiles & Pure Joy',
  ...
  },
  {
    ...
    type: 'image',
    url: '/IMG_6702.PNG',
    caption: 'Sparkling Laughter',
    subtitle: 'Moments of unfiltered happiness and wondrous cheer 🌟',
  },
  {
    id: 'slide-4',
    type: 'image',
    url: '/IMG_6703.PNG',
    caption: 'Radiant Sunshine & Grace',
    subtitle: 'Graceful moments that shine bright like the golden sun 🌸',
  },
  {
    id: 'slide-5',
    type: 'image',
    url: '/IMG_6706.PNG',
    caption: 'Warmest Sunshine',
